...
moins:
	cmp $2,%r12     /*Regarde si le nombre d'opérande est supérieur à 2*/
        jl errorQuit    /*Si mauvais nombre d'opérande imprime ErrorQuit*/ 	
	pop %rdi        /* On tire le premier parametre de la pile*/
        pop %rsi        /* On tire le second parametre de la pile*/
...
/* Les differentes fonction */
.globl addition
.type  addition, @function
/*** Fonction :: addition
* Additionne les deux paramètres et renvoie le résultat
* Paramètre rdi : le premier terme
* Paramètre rsi : le second terme
* Retour        : le résultat de l'addition
*/
addition:
push %rbp                 /* Intro fonction */
movq %rsp, %rbp
add %rdi, %rsi            /* On fait l'addition */
mov %rsi, %rax            /* On déplace la valeur pour la renvoyer */
movq %rbp, %rsp           /* Fin de fonction */
pop %rbp
ret
...
/*** Fonction :: division
* Divise les deux paramètre et renvoie le résultat
* Paramètre rdi : le premier terme dividende
* Paramètre rsi : le second terme diviseur
* Retour        : le résultat de la division
*/
division:
push %rbp                 /* Intro fonction */
movq %rsp, %rbp
movq $0,%rdx		/* Initialise rdx le stockage du reste*/
movq %rdi, %rax            /* On déplace le premier terme dans rax */
movq %rsi, %rcx            /* On déplace le deuxième terme dans rbx */
div %rcx                 /* On fait la division */
movq %rbp, %rsp           /* Fin de fonction */
pop %rbp
ret
...
* Soustrait les deux paramètres et renvoie le résultat
* Paramètre rdi : le premier terme
* Paramètre rsi : le second terme
* Retour        : le résultat de la soustraction
*/
soustraction:
push %rbp                 /* Intro fonction */
movq %rsp, %rbp
sub %rdi, %rsi            /* On fait la soustractino */
mov %rsi, %rax            /* On déplace la valeur pour la renvoyer */
movq %rbp, %rsp           /* Fin de fonction */
pop %rbp
ret
...
* Multiplie les deux paramètre et renvoie le résultat
* Paramètre rdi : le premier terme
* Paramètre rsi : le second terme
* Retour        : le résultat de la multiplication
*/
multiplication:
push %rbp                 /* Intro fonction */
movq %rsp, %rbp
mov %rdi, %rax            /* On déplace le premier terme dans rax */
mov %rsi, %rbx            /* On déplace le deuxième terme dans rbx */
imul %rbx                 /* On fait la multiplication */
movq %rbp, %rsp           /* Fin de fonction */
pop %rbp
ret
